...
A common task when dealing with strings is the need to split a single string into many parts.
...
Use `str_split_one()` when the input is known to be a single string, e.g., "a, b, c".
It will error if its input has length greater than one, 
such as c("a, b", "c, d")
